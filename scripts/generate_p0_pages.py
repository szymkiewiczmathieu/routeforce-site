...
PAGES = {
    'salesforce-maps-mobile-retirement.html': {
        'title': 'Salesforce Maps Mobile Retirement: Current Guidance (2026)',
        'h1': 'Salesforce Maps mobile retirement: current guidance for field teams',
        'description': 'Salesforce announced August 31, 2026 as the standalone Maps mobile app retirement date. Review the notice, its scope, and route-planning alternatives.',
        'kicker': 'News',
        'date': '2026-07-19',
        'read': '6 min read',
        'summary': 'Salesforce announced August 31, 2026 as the retirement date for the standalone Salesforce Maps mobile app. Field teams should review the notice, document affected workflows, and test their options against current requirements.',
        'body': [
            ('h2', 'What exactly is retiring?'),
            ('p', 'Salesforce announced August 31, 2026 as the retirement date for the standalone Salesforce Maps mobile app. Its notice says the Salesforce Maps desktop experience is unaffected and directs users to the Maps Mobile tab in the Salesforce mobile app. Check the current notice for the applicable scope and guidance.'),
            ('p', 'When checked on September 5, 2026, Salesforce’s public Help pages had not yet confirmed completion in past tense. Plan against the official notice and your current contract rather than assuming a storefront or installed-app status.'),
            ('h2', 'Why this matters for field sales teams'),
            ('p', 'Teams that used the standalone app should identify the affected route planning, navigation, check-in, record update, and reporting steps. The right next action depends on the workflows, devices, and Salesforce configuration in use.'),
            ('p', 'A transition can involve training, data cleanup, and configuration changes. Test the chosen workflow with representative records before rollout.'),
            ...
            ('ul', [
                ...
                'A Salesforce Mobile workflow or separate field application that fits the team',
            ...
            ('p', 'Managed packages and separate field apps use different interfaces and data flows. Test both models against your Salesforce objects, mobile devices, and reporting requirements.'),
            ('h2', 'How to plan a transition'),
            ('p', 'Keep the scope focused on the workflows that matter to the field team:'),
            ('ol', [
                ...
                'Test one alternative in a sandbox with representative users and workflows.',
