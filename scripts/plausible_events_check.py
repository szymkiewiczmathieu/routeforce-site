...
PERIOD = os.environ.get("PLAUSIBLE_PERIOD", "day")
...
def main():
    ...
    appx_today = fetch_json(base_url, api_key, "/api/v1/stats/breakdown", {
        "site_id": SITE_ID,
        "period": PERIOD,
        "property": "event:page",
        "metrics": "visitors,pageviews,visits",
    ...
    form_today = fetch_json(base_url, api_key, "/api/v1/stats/breakdown", {
        "site_id": SITE_ID,
        "period": PERIOD,
        "property": "event:page",
        "metrics": "visitors,pageviews,visits",
    ...
    result = {
        ...
        "appx_pages": appx_today.get("results", []),
        "lead_form_pages": form_today.get("results", []),
    }
