# KIT CONTRACTUEL ROUTEFORCE

## 📋 DOCUMENTS DISPONIBLES

### 1. **Documents légaux obligatoires**
- [Conditions Générales de Vente (CGV)](cgv.html) — ✅ **PRINCIPAL**  
  Contrat de base pour les 3 formules. Article 4 = tableau comparatif.
- [Mentions légales FR](mentions-legales.html) — obligatoire sur le site
- [Legal Notice EN](mentions-legales-en.html) — version anglaise

### 2. **Modèles de devis par formule**
- [Devis Formule Autonome](devis-autonome.md) — 350€ HT install (-90% promo) + 30€ HT / utilisateur / mois
- [Devis Formule Clé en main](devis-cle-en-main.md) — 5 000€ HT install + 30€ HT / utilisateur / mois
...
### **Période d'essai**
Toutes les formules incluent 30 jours d'essai gratuit.  
Aucune donnée conservée au-delà de 30 jours après l'essai.

### **RGPD / Données**
- Tes CGV précisent que tu es **sous-traitant** (article 10)
- Seules les coordonnées GPS transitent vers ton infrastructure
- Hébergement France (OVH Gravelines) par défaut
- Pour Enterprise : choix de région possible (majoration)

### **Propriété intellectuelle**
- Tu restes propriétaire du code Tourvia
- Le client a une licence d'utilisation limitée à la durée du contrat
- Les données du client restent sa propriété

## 📞 CONTACT JURIDIQUE
Pour une relecture juridique professionnelle (~200-300€) :
- **LegalPlace** (legalplace.fr)
- **Captain Contrat** (captaincontrat.com)
- **Contract Factory** (pour les SaaS)
